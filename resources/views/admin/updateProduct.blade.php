    ...
    <div class="container position-absolute top-50 start-50 translate-middle shadow-sm p-3 mb-5 bg-body-tertiary rounded">
        ...
        <form action="{{route('product.update', $product->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name_input" name="name" placeholder="name.." value="{{$product->name}}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="integer" class="form-control" id="price_input" name="price" placeholder="e.x: 10,20" value="{{$product->price}}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="integer" class="form-control" id="stock_input" name="stock" placeholder="e.x: 10,20" value="{{$product->stock}}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" id="photo_input" name="photo" placeholder="e.x: 10,20" value="{{$product->photo}}">
            </div>
